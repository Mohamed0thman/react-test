...
module.exports = {
  ...
  safelist: [
    {
      pattern: /bg-/, // the "." means "everything"
    },
    {
      pattern: /text-/,
    },
  ...
  theme: {
    ...
    extend: {
      ...
      backgroundImage: {
        'slider-bg': "url('/src/assets/slider/background.png')",
        'sliderLeft-bg': "url('/src/assets/slider/slider1.png')",
        service: "url('/src/assets/service/service.png')",
        vedioImg: "url('/src/assets/Video-img/img1.png')",
        PropertyDefult: "url('/src/assets/properties/property-1.png')",
        paySuccess: "url('/src/assets/messages/base.png')",
        mailBox: "url('/src/assets/messages/mailbox.png')",
        successMessage: "url('/src/assets/messages/success2.png')",
        caravan: "url('/src/assets/caravan.png')",
      },
      borderWidth: {
        3: '3px',
      },
